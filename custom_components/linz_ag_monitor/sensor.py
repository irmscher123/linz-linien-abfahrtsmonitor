...
async def async_setup_entry(hass, config_entry, async_add_entities):
    ...
    try:
        ...
        _LOGGER.warning("Erstes Laden für %s verzögert sich durch Datenbankbau...", name)

    # Erstellt 19 Entitäten für das Dashboard
    ...
    async def _async_update_data(self):
        try:
            ...
            for d in departures:
                ...
                # Phantom-Filter: Nur anzeigen wenn Realtime oder außerhalb API-Sichtweite
